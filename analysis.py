...
def analyze_dir(to_analyze, txt_dir, res_path):
    ...
    for fn in tqdm(os.listdir(to_analyze)):
        ...
        for relation in relations:
            ...
            if relation.attrib["pdtb3_sense"] in sense_counts:
        ...
        if empt_in_doc:
            rels_doc_with_empt += len(relations)
            doc_empt_arg += 1
...
#analyze_dir("/data/europarl/common/pcc_labels/from_en",
#            "/data/europarl/common/txt/de",
#            "/data/europarl/common/analysis/from_en.txt")
...
#analyze_transfer(orig_dir, trans_dir, out_path):
